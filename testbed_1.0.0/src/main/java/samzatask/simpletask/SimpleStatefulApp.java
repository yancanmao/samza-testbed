...
import samzatask.simpletask.SimpleStatefulTask;

import java.util.List;
import java.util.Map;

public class SimpleStatefulApp implements TaskApplication {
    ...
    private static final String INPUT_STREAM_ID = "task-input";
    private static final String OUTPUT_STREAM_ID = "task-output";
    ...
    public void describe(TaskApplicationDescriptor taskApplicationDescriptor) {
        ...
        taskApplicationDescriptor.withTaskFactory((StreamTaskFactory) () -> new SimpleStatefulTask());
    }
...
//        LocalApplicationRunner runner = new LocalApplicationRunner(new WordCountApp(), config);
//        runner.run();
