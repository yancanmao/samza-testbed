...
public class WordCountCounterApp implements TaskApplication {
    ...
    private static final String OUTPUT_STREAM_ID = "counts";
    ...
    public void describe(TaskApplicationDescriptor taskApplicationDescriptor) {
        ...
        taskApplicationDescriptor.withTaskFactory((StreamTaskFactory) WordCountCounterTask::new);
    }
    ...
    public static void main(String[] args) {
        ...
        LocalApplicationRunner runner = new LocalApplicationRunner(new WordCountCounterApp(), config);
        runner.run();
