...
public class SentimentAnalysisApp implements TaskApplication {
    ...
    private static final String INPUT_STREAM_ID = "sa_input";
    private static final String OUTPUT_STREAM_ID = "sa_output";
    ...
    public void describe(TaskApplicationDescriptor taskApplicationDescriptor) {
        ...
        taskApplicationDescriptor.withTaskFactory((StreamTaskFactory) () -> new SentimentAnalysisTask());
    }
    ...
    public static void main(String[] args) {
        ...
        LocalApplicationRunner runner = new LocalApplicationRunner(new SentimentAnalysisApp(), config);
        runner.run();
